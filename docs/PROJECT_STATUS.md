...
| WES cluster | Input-generation evidence, complete alignment inventory and five reference/resource hashes are received. Remaining gaps are exact manual invocation/image/full-source records where recoverable, beta known-indels resource, liftover/converter provenance and additional existing normal QC. See the updated targeted follow-up; do not repeat resolved retrievals. |
...
The subsequent [expanded analysis](../reports/molecular_extension_2026-09-06/README.md) covers 52 CN loci, 19 expression targets, 65 exact variant candidates and SBS3 reference/filter/bootstrap sensitivity. AKT2/OV3331 is a concordant DNA/RNA/protein lead; NF1/CDKN2A depletion needs exon/read validation. No model has dictionary-robust positive SBS3 support. The current operational cluster handoff is [MEX01–MEX11](cluster/molecular_extension_2026-09-06/AGENT_TASK.md), with model aliases, candidate regions, input/status templates and a portable overlay builder. The [new cluster return](cluster/recovery/2026-09-06-molecular_extension/LOCAL_REVIEW.md) inventories complete md CRAMs for all 23 models and explains interval-restricted historical CNV inputs. The [reviewed execution plan](cluster/molecular_extension_2026-09-06/EXECUTION_PLAN.md) corrects PureCN/import and normal-processing assumptions, expands read review to 30 variants, and specifies MSI/SNP/ASCN pilots with conditional scar analysis. Source recovery records and explicit execution manifests are retained. No pilot results have yet been returned or jobs submitted from this workstation; this update is to the plan/provenance, not manuscript v9 or the release. The author-approved [NCBI/ClinVar query](../reports/molecular_extension_2026-09-06/variants/clinvar/README.md) is complete: 23 of 53 alleles match exact records, covering 29 model observations. Updated ATR/PTEN/BRAF annotations and conflicting classifications are retained with their separate evidence scopes.
