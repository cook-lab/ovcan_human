#!/usr/bin/env python3
"""Build the Scientific Data v9 working manuscript from its Markdown source.

This script writes only to the new v9 manuscript directory.
"""
...
SOURCE = ROOT / "OvCAN_Scientific_Data_draft_v9.md"
OUTPUT = ROOT / "OvCAN_Scientific_Data_draft_v9.docx"
...
def parse_markdown(doc: Document, source: str) -> None:
    ...
    while idx < len(lines):
        ...
        if line.startswith("## "):
            ...
            # A standalone break paragraph can spill onto an otherwise empty
            # page when the preceding references exactly fill their page.
            p.paragraph_format.page_break_before = current_major in {"Tables", "Figure legends"}
...
def add_document_metadata(doc: Document) -> None:
    ...
    props.comments = "Version 9; explicit TODO markers link to author_confirmation.md."
