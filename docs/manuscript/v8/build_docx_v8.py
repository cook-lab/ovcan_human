#!/usr/bin/env python3
"""Build the Scientific Data v8 working manuscript from its Markdown source.

This script writes only to the new v8 manuscript directory.
"""
...
SOURCE = ROOT / "OvCAN_Scientific_Data_draft_v8.md"
OUTPUT = ROOT / "OvCAN_Scientific_Data_draft_v8.docx"
...
def add_document_metadata(doc: Document) -> None:
    ...
    props.comments = "Version 8; explicit TODO markers link to author_confirmation.md."
