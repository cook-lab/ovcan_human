...
FIELD_DEFINITIONS = {
    ...
    "log2_raw": "Archived CNVkit segment log2 ratio before project recentring.",
    ...
    "probes": "Number of CNVkit bins supporting a segment.",
    "weight": "Archived CNVkit segment weight.",
